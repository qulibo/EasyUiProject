...
public interface EmpMapper {
    ...
    @Insert({
        ...
        "#{sex,jdbcType=INTEGER}, #{age,jdbcType=INTEGER}, #{sal,jdbcType=DECIMAL}, ",
        "#{post,jdbcType=VARCHAR}, #{deptid,jdbcType=INTEGER})"
    })
    ...
    @Select({
        "select",
        "id, ename, sex, age, sal, post, deptid",
        "from emp",
        "where id = #{id,jdbcType=INTEGER}"
    })
    @Results({
